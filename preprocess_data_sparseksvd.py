...
def load_generated_data(options):
    normal_data = np.load(os.path.join(options.dataset_path, 'log_idct_mel_valve_00_0.01thresh_normal.npy'))
    abnormal_data = np.load(os.path.join(options.dataset_path, 'log_idct_mel_valve_00_0.01thresh_abnormal.npy'))
